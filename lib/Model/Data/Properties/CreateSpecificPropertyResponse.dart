...
class CreateSpecificPropertyResponse {
  // Constructor
  CreateSpecificPropertyResponse({
    required this.id,
  ...
  factory CreateSpecificPropertyResponse.fromJson(Map<String, dynamic> json) {
    return CreateSpecificPropertyResponse(
      id: json['id'] as num,
  ...
  // Copy with method
  CreateSpecificPropertyResponse copyWith({
    num? id,
    num? userId,
    String? name,
    String? description,
