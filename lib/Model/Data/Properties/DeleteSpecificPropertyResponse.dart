...
class DeleteSpecificPropertyResponse {
  // Constructor
  DeleteSpecificPropertyResponse({
    required this.id,
  ...
  factory DeleteSpecificPropertyResponse.fromJson(Map<String, dynamic> json) {
    return DeleteSpecificPropertyResponse(
      id: json['id'] as num,
  ...
  // Copy constructor
  DeleteSpecificPropertyResponse copyWith({
    num? id,
    num? userId,
    String? name,
    String? description,
